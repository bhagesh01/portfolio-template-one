...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="flex-1 flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 md:py-10">
          <div className="max-w-4xl pt-20">
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold text-gray-900 mb-8">
            ...
            >
              <Link
                to="/services"
                className="group relative inline-flex items-center overflow-hidden rounded-full bg-indigo-600 px-6 sm:px-8 py-3 sm:py-4 text-white focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2"
              >
      ...
      <div className="absolute h-fit w-fit lg:flex flex-col items-center justify-center gap-3 border-[1px] rounded-full p-2 right-6 md:right-16 bottom-10 hidden">
      ...
      <footer
        className="sm:hidden flex items-center justify-between px-6 sm:px-8 py-6 sm:py-8 border-b-0 border-[1px]
